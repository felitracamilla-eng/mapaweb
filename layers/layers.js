...
lyr_UnidadesVegetacionChubut_0.set('fieldAliases', {'CODIGO': 'CODIGO', 'REGION': 'REGION', 'DOMINIO': 'DOMINIO', 'UNID_FITOG': 'UNID_FITOG', 'NOMFISONOM': 'TIPO DE VEGETACION', 'NOMVULGAR': 'NOMVULGAR', 'SUP_HA': 'SUP_HA', 'X': 'X', 'Y': 'Y', 'ROTATION': 'ROTATION', });
...
lyr_LocalidadesCHUBUT_1.set('fieldLabels', {'gid': 'hidden field', 'nombre_geo': 'inline label - always visible', 'tipo_asent': 'hidden field', 'codigo_ase': 'hidden field', 'nombre_agl': 'hidden field', 'codigo_agl': 'hidden field', 'nombre_dep': 'hidden field', 'codigo_ind': 'hidden field', 'nombre_pro': 'hidden field', 'codigo_in0': 'hidden field', 'latitud_gr': 'hidden field', 'longitud_g': 'hidden field', 'latitud_g0': 'hidden field', 'longitud_0': 'hidden field', 'fuente_de_': 'hidden field', });
