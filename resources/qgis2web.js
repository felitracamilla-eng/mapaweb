...
map.getView().fit([-9238976.058548, -5861169.940902, -6349109.627710, -5046510.502932], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">UNIDADES VEGETACION </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (20 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'TRACAMILLA GEOGRAFIA';
            }
